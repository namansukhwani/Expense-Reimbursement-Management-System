...
export class InitialSchema1780413553941 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."user_role_enum" AS ENUM('EMPLOYEE', 'MANAGER', 'ADMIN')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_45926a4ecbc253ec32ef949389" ON "claim_status_history"  ("claim_id") `,
    );
    await queryRunner.query(
      `CREATE TABLE "approval_action" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "claim_id" uuid NOT NULL, "manager_id" uuid NOT NULL, "action" character varying NOT NULL, "approval_level" integer NOT NULL DEFAULT '1', "comment" text, CONSTRAINT "PK_6e8d36a051ed4b3f6a14e7aebdb" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_0595f771e52655fdee1e734dd4" ON "approval_action"  ("claim_id") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_c7aadab058c33c3812ab5f1fe9" ON "approval_action"  ("manager_id") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_20013a0bd0a31f74ebebf535f7" ON "reimbursement_claim"  ("user_id") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_2cbcf87a54ac23c6294ada82ee" ON "audit_log"  ("entity_type") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_c6c5d74b38ecfe778182348e7c" ON "audit_log"  ("entity_id") `,
    );
    await queryRunner.query(
      `ALTER TABLE "claim_status_history" ADD CONSTRAINT "FK_45926a4ecbc253ec32ef9493895" FOREIGN KEY ("claim_id") REFERENCES "reimbursement_claim"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "claim_status_history" ADD CONSTRAINT "FK_fc50bf1ee9fe5528b56d5bc624a" FOREIGN KEY ("changed_by_id") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "approval_action" ADD CONSTRAINT "FK_0595f771e52655fdee1e734dd42" FOREIGN KEY ("claim_id") REFERENCES "reimbursement_claim"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "approval_action" ADD CONSTRAINT "FK_c7aadab058c33c3812ab5f1fe96" FOREIGN KEY ("manager_id") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "reimbursement_claim" ADD CONSTRAINT "FK_20013a0bd0a31f74ebebf535f71" FOREIGN KEY ("user_id") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "reimbursement_claim" ADD CONSTRAINT "FK_52866bbb666b4c0abdf2c73bdbd" FOREIGN KEY ("department_id") REFERENCES "department"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "expense" ADD CONSTRAINT "FK_384f058815790336aac12e4b92c" FOREIGN KEY ("claim_id") REFERENCES "reimbursement_claim"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "audit_log" ADD CONSTRAINT "FK_15a6f5aad57db494c17986ed2e2" FOREIGN KEY ("actor_id") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "audit_log" DROP CONSTRAINT "FK_15a6f5aad57db494c17986ed2e2"`,
    );
    await queryRunner.query(
      `ALTER TABLE "expense" DROP CONSTRAINT "FK_384f058815790336aac12e4b92c"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "reimbursement_claim" DROP CONSTRAINT "FK_52866bbb666b4c0abdf2c73bdbd"`,
    );
    await queryRunner.query(
      `ALTER TABLE "reimbursement_claim" DROP CONSTRAINT "FK_20013a0bd0a31f74ebebf535f71"`,
    );
    await queryRunner.query(
      `ALTER TABLE "approval_action" DROP CONSTRAINT "FK_c7aadab058c33c3812ab5f1fe96"`,
    );
    await queryRunner.query(
      `ALTER TABLE "approval_action" DROP CONSTRAINT "FK_0595f771e52655fdee1e734dd42"`,
    );
    await queryRunner.query(
      `ALTER TABLE "claim_status_history" DROP CONSTRAINT "FK_fc50bf1ee9fe5528b56d5bc624a"`,
    );
    await queryRunner.query(
      `ALTER TABLE "claim_status_history" DROP CONSTRAINT "FK_45926a4ecbc253ec32ef9493895"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_c6c5d74b38ecfe778182348e7c"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_2cbcf87a54ac23c6294ada82ee"`,
    );
    await queryRunner.query(`DROP TABLE "audit_log"`);
    await queryRunner.query(`DROP TABLE "expense"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_20013a0bd0a31f74ebebf535f7"`,
    );
    await queryRunner.query(`DROP TABLE "reimbursement_claim"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_c7aadab058c33c3812ab5f1fe9"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_0595f771e52655fdee1e734dd4"`,
    );
    await queryRunner.query(`DROP TABLE "approval_action"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_45926a4ecbc253ec32ef949389"`,
    );
    await queryRunner.query(`DROP TABLE "claim_status_history"`);
    await queryRunner.query(`DROP TABLE "system_setting"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_55222eaccf1590e2c233c75158"`,
    );
